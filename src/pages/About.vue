  ...
  <b-row align-h="center" align-v="center">
    <b-col sm="10" md="8">
      <b-card class="p-4">
        ...
        <p class="pb-3">Lumenshine is a Wallet for the decentralized Stellar network. Lumenshine is developed and maintained by <a href="https://soneso.com" target="_blank" rel="noopener">Soneso GmbH</a>, a company from Munich, Germany. The Stellar network is hosted by numerous distributed nodes world-wide who are not under the control of any single entity or groups of entities. Lumenshine does not control the Stellar network and it is not created, sponsored or endorsed by the Stellar Development Foundation.</p>
        ...
        <p class="pb-3">Lumenshine is available for web and as a native app for iOS.</p>
        ...
        <p class="pb-3"><a href="https://soneso.com" target="_blank" rel="noopener">Soneso GmbH</a> is a company from Munich, Germany. We are specialized on the Stellar network, offering consulting and development services related to the Stellar Ecosystem.</p>
      </b-card>
    </b-col>
  </b-row>
</template>
