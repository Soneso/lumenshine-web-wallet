    ...
    <b-col sm="10" md="8">
      <b-card class="p-2 p-md-4">
        <b-row>
          ...
          <b-col cols="12">
            <h1 class="pt-3">PRIVACY POLICY</h1>
            <small>Effective Date of Privacy Policy: November 15, 2018</small>
            <br>
          </b-col>

          <b-col cols="12">
            <h2 class="pt-4">IMPORTANT INFORMATION AND WHO WE ARE</h2>
            <h3>PURPOSE OF THIS PRIVACY POLICY</h3>

            <p>This Privacy Policy describes the policies and procedures of Soneso GmbH (“we”, “our” or “us”) on the collection, use, and disclosure of your information on <a href="https://lumenshine.com">https://lumenshine.com</a> (the “Site”) and the services, features, content or applications we offer (collectively with the Site, the “Services”). We receive information about you from various sources, including: (i) your use of the Services generally; and (ii) from third party websites and services.</p>
            ...
            <h2 class="pt-4">CONTROLLER</h2>
            <p>Soneso GmbH is the controller and responsible for your Personal Data (collectively referred as “Soneso”, “we”, “our” or “us”).</p>

            <p>We have appointed a data privacy manager who is responsible for overseeing questions in relation to this Privacy Policy. If you have any questions about this Privacy Policy, including any requests to exercise your legal rights, please contact us using the details set out below.</p>

            <h2 class="pt-4">CONTACT DETAILS</h2>
            <p>If you have any questions about this Privacy Policy or our privacy practices, please contact us in the following ways:</p>

            <p>Soneso GmbH Email address: <a href="mailto:support@lumenshine.com">support@lumenshine.com</a>  Postal address: Soneso GmbH, Römerstrasse 33, 80803 München, Germany</p>

            <h2 class="pt-4">CHANGES TO THE PRIVACY POLICY AND YOUR DUTY TO INFORM US OF CHANGES</h2>
            ...
            <h2 class="pt-4">THIRD-PARTY LINKS</h2>
            ...
            <h2 class="pt-4">WHAT INFORMATION DO WE COLLECT?</h2>
            ...
            <h2 class="pt-4">PERSONAL DATA</h2>
            ...
            <h2 class="pt-4">TRANSACTIONS ON STELLAR</h2>
            <p>You may submit transactions, data, and other information to the Stellar network using our Services. All information submitted to the Stellar network is accessible by the public and is stored by distributed and potentially anonymous parties across the globe. We do not retain any control over any transaction data that you submit using our Services to the Stellar network. You acknowledge that all information that you submit to the Stellar network may be stored by third parties indefinitely.</p>

            <h2 class="pt-4">IP ADDRESS INFORMATION AND OTHER INFORMATION COLLECTED AUTOMATICALLY</h2>
            ...
            <h2 class="pt-4">EMAIL COMMUNICATIONS</h2>
            ...
            <h2 class="pt-4">INFORMATION COLLECTED USING COOKIES</h2>
            ...
            <h2 class="pt-4">INFORMATION RELATED TO ADVERTISING AND THE USE OF WEB BEACONS</h2>
            ...
            <h2 class="pt-4">AGGREGATE DATA</h2>
            ...
            <h2 class="pt-4">INFORMATION REGARDING YOUR SOCIAL NETWORKS</h2>
            ...
            <h2 class="pt-4">SPECIAL CATEGORIES OF PERSONAL DATA</h2>
            ...
            <h2 class="pt-4">HOW IS YOUR PERSONAL DATA COLLECTED?</h2>
            <p>We use different methods to collect data from and about you including through:</p>

            <ul class="has-bullets pl-4 pb-4">
              <li>Direct Interactions. You may give use your Personal Data by filling in forms or corresponding with us by post, phone, email, or otherwise. This includes Personal Data you provide when you</li>
              ...
              <li>Submit transaction data to the Stellar Network;</li>
              <li>Request marketing to be sent to you; or</li>
              <li>Give us feedback or contact us.</li>
            </ul>

            <p>Automated Technologies or Interactions. As you interact with our Site, we will automatically collect Technical Data about your equipment, browsing actions, and patterns. We collect this Personal Data by using cookies and other similar technologies.</p>

            <p>Third Parties. We will receive Personal Data about you from various third parties as set out below:</p>

            <p>Analytics providers such as Google;</p>
            <p>Social Networks, such as Facebook and Twitter, as described above.</p>
            <h2 class="pt-4">HOW IS THE INFORMATION WE COLLECT USED?</h2>
            ...
            <p>We use information from the Site to prevent, detect, and investigate fraud, security breaches, potentially prohibited or illegal activities, and enforce our Terms of Service, which is necessary for our legitimate interests</p>
            ...
            <h2 class="pt-4">HOW, AND WITH WHOM, IS MY INFORMATION DISCLOSED?</h2>
            ...
            <h2 class="pt-4">PUBLIC INFORMATION ABOUT YOUR ACTIVITY ON THE SERVICES</h2>
            <p>Some of your activity on and through the Services is public by default. This may include, but is not limited to all transactions and operations on the Stellar network.</p>
            ...
            <h2 class="pt-4">IP ADDRESS INFORMATION</h2>
            ...
            <h2 class="pt-4">INFORMATION YOU ELECT TO SHARE</h2>
            ...
            <h2 class="pt-4">AGGREGATE INFORMATION</h2>
            ...
            <h2 class="pt-4">EMAIL COMMUNICATIONS WITH US</h2>
            ...
            <h2 class="pt-4">INFORMATION SHARED WITH OUR AGENTS</h2>
            ...
            <h2 class="pt-4">INFORMATION DISCLOSED PURSUANT TO BUSINESS TRANSFERS</h2>
            ...
            <h2 class="pt-4">INFORMATION DISCLOSED FOR OUR PROTECTION AND THE PROTECTION OF OTHERS</h2>
            ...
            <h2 class="pt-4">INFORMATION WE SHARE WITH AD NETWORKS</h2>
            ...
            <h2 class="pt-4">INFORMATION WE SHARE WITH YOUR CONSENT</h2>
            ...
            <h2 class="pt-4">INTERNATIONAL TRANSFERS</h2>
            ...
            <h2 class="pt-4">IS INFORMATION ABOUT ME SECURE?</h2>
            ...
            <p>It is your responsibility to make sure that your Personal Data is accurate and that your password(s), private keys, mnemonic and account registration information are secure and not shared with third-parties. We cannot assist in recovery of the loss of private keys or mnemonic.</p>

            <h2 class="pt-4">HOW LONG WILL YOU USE MY PERSONAL DATA FOR?</h2>
            ...
            <p>By law we have to keep basic information about our customers for ten years after they cease being customers.</p>
            ...
            <h2 class="pt-4">WHAT INFORMATION OF MINE CAN I ACCESS?</h2>
            <p>Users can access and delete cookies through their web browser settings.</p>

            <p>You may email <a href="mailto:support@lumenshine.com">support@lumenshine.com</a> at any time to obtain a copy of the information that we may have gathered and retained about you.</p>

            <p>Registered members can review and change Personal Data at any time by accessing their accounts on the Site or mobile app. You should promptly update your Personal Data if it changes or becomes inaccurate.</p>
            ...
            <h2 class="pt-4">WHAT CHOICES DO I HAVE REGARDING MY INFORMATION?</h2>
            ...
            <p>You may email <a href="mailto:support@lumenshine.com">support@lumenshine.com</a> and request that we delete all of your Personal Data. We will make such a deletion within fifteen (15) business days.</p>

            <h2 class="pt-4">LEGAL RIGHTS FOR EEA RESIDENTS</h2>
            ...
            <ul class="has-bullets pl-4 pb-4">
              ...
              <li>If you wish to exercise any of the rights set out above, please contact <a href="mailto:support@lumenshine.com">support@lumenshine.com</a> .</li>
            </ul>
