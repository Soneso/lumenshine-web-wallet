    ...
    <b-col sm="10" md="8">
      <b-card class="p-2 p-md-4">
        <b-row>
          ...
          <b-col cols="12">
            <h1 class="pt-3">Wallet Guidelines</h1>
            <small>Last updated: November 15, 2018</small>
            <br><br>
          </b-col>

          <b-col cols="12">
            <p>When you sign up for Lumenshine, you agree to our terms of service, which explain in detail the requirements and conditions for using the site or mobile apps. Make sure you read and understand those terms of service: these guidelines aren't meant to replace them, just to give you a concise overview of some key concepts to keep in mind as you use Lumenshine.</p>
            ...
            <p>In addition, because transactions are immediate and irreversible, if someone else gains access to your account, they can instantly withdraw all of your assets. Never share your stellar secret keys, password and mnemonic (backup secret) with anyone, including Lumenshine. We'll never ask you for it, and anyone who does is trying to scam you.</p>
            <p>If you activate fingerprint or face recognition on your mobile device for the Lumenshine app, you must understand that your password will be saved by the app in a secure location on your device (such as in the Keychain on iOS devices). The app can then access your password to log you in automatically or to sign transactions for you when you provide your fingerprint / face. If you enable face or fingerprint recognition in your mobile app, we can not guarantee for the security of your password. It is protected by your device, not by us. You do this on your own risk. </p>
