      ...
      <b-card class="p-4">
        <b-row>
          <b-col cols="12" lg="4" xlg="3">
            ...
            <p class="lead">Lumenshine is a multi-platform, user-friendly, fully-featured wallet app for the decentralized Stellar network. <br><br>Lumenshine is available for web and iOS.<br></p>
            <p class="lead"><a href="https://itunes.apple.com/us/app/lumenshine/id1441524975" target="_blank" rel="noopener"><img style="width: 140px" src="/static/Download_on_the_App_Store_Badge.svg"></a></p>
          </b-col>
          <b-col>
          ...
          <b-col>
            <a href="/login"><img src="/static/iphone-screenshot-home.png" style="width: 90%"></a><br><br>
          </b-col>
          <b-col cols="12" lg="6" xlg="3">
            ...
            <h2 class="text-info">Fast and free</h2>
            <p>Transactions settle in seconds and you only need to pay the Stellar network transaction fee. No transaction fee has to be payed to Lumenshine.<br><br></p>
          ...
          <b-col cols="12" class="py-3">
            ...
            <p>Lumenshine is open source software developed by <a href="https://soneso.com" target="_blank" rel="noopener">Soneso</a>, a company from Munich, Germany. You can find the Lumenshine source code in our <a href="https://github.com/soneso" target="_blank" rel="noopener">github repository</a>. Anybody can access, audit or review the Lumenshine source code.</p>
          </b-col>
          <b-col cols="12" class="py-3">
            <hr class="divider light">
            <h3 class="text-info">Focused on security and usability</h3>
            <p>Lumenshine uses two factor authentication and strong cryptography to protect your sensitive data. On registration, Lumenshine generates a 24 words backup passphrase for you, also called "mnemonic". You must write it down to be able to finish the setup process. Your mnemonic is not only used as a backup, but also to create new wallets and to sign transactions on your behalf.</p>
            <p>Lumenshine is a custodial wallet. It utilizes your password to store an encrypted form of your mnemonic on the server. Your password and the plain version of your mnemonic are never sent to the server. Therefore Lumenshine is not a custodian of your assets. Your mnemonic can only be decrypted on your device and your transactions can only be signed by the client on your device. We encourage you to read all the details about Lumenshine's advanced wallet security in our <a href="https://github.com/Soneso/lumenshine-concepts/blob/master/Wallet/Security/white-paper/Lumenshine-Wallet-Security-WP.pdf" target="_blank" rel="noopener">Wallet Security White Paper.</a></p>
            <p>With Lumenshine you don't have to type in long, error prone strings of random characters called secret seeds or private keys to sign and submit transactions to the Stellar network. You must only insert your password or use biometric auth to approve your transaction.</p>
          </b-col>
          <b-col cols="12" class="py-3 text-center">
            <hr class="divider light">
            <div class="py-3">
              <div class="lead pb-4">Sign up now and set-up your new Lumenshine wallet!</div>
              <b-button href="/register" size="lg" variant="outline-success" class="btn-rounded text-uppercase mx-3 mb-2">sign up</b-button>
              <b-button href="/login" size="lg" variant="outline-info" class="btn-rounded text-uppercase mx-3 mb-2">log in</b-button>
            </div>
          </b-col>
          ...
          <b-col cols="12" class="py-3">
            ...
            <p>The Stellar network is hosted by numerous distributed nodes world-wide who are not under the control of any single entity or groups of entities. Lumenshine is only an interface for the Stellar network and does not control the Stellar network. It is not created, sponsored or endorsed by the Stellar Development Foundation.</p>
          </b-col>
        </b-row>
      </b-card>
    </b-col>
