      ...
      <b-card class="p-4">
        <b-row>
          ...
          <b-col cols="12" class="py-3">
            ...
            <p>Lumenshine uses two factor authentication and strong cryptography to protect your sensitive data. On registration, Lumenshine generates a 24 words backup passphrase for you, also called "mnemonic". You must write it down to be able to finish the setup process. Your memonic is not only used as a backup, but also to create new wallets and to sign transactions on your behalf.</p>
