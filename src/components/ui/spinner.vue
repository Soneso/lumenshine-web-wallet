<template>
  <div :style="spinnerContainerStyle" :class="spinnerContainerClass">
...
export default {
  ...
  computed: {
    ...
    spinnerContainerClass () {
      ...
      if (this.inline) classes.push('inline-spinner');
      switch (this.align) {
        case 'none':
          break;

        case 'left':
          classes.push('pull-left clearfix');
          break;

        case 'right':
          classes.push('pull-right clearfix');
          break;
